...
public:
	ShrineMaiden(char Name[15], Vector2f Pos) {
		...
		if (!tUnlock1.loadFromFile("Assets\\Reimu_character\\Reimu_2.png")) {
			cout << "Failed to load image";
		}

		if (!tUnlock2.loadFromFile("Assets\\Reimu_character\\Reimu_3.png")) {
			cout << "Failed to load image";
		}

		if (!tUnlock3.loadFromFile("Assets\\Reimu_character\\Reimu_4.png")) {
			cout << "Failed to load image";
		}
